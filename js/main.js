...
// Function to load reviews from Local Storage when the page loads
function loadReviewsFromLocalStorage() {
    const storedReviews = localStorage.getItem('reviews');
    if (storedReviews) {
        reviews = JSON.parse(storedReviews);
        console.log('Reviews loaded from Local Storage:', reviews);
    }
}
...
function saveReviewsToLocalStorage() {
    ...
    console.log('Reviews saved to Local Storage');
}

// Load data from JSON file or Local Storage when the page loads
...
const openAddReviewModal = (businessId) => {
    ...
    addReviewForm.onsubmit = (event) => {
        ...
        if (rating && reviewer) {
            ...
            saveReviewsToLocalStorage(); // Save reviews to local storage
